...
def calculate_MAF_hist(fn, samples, unrel_samples, Chroms, bed_exclude = False, prefix = False, output_dir=False, maf_col = 'MAF_UNREL', add_unrel_to_info = False, vcf_name=False):
...
def add_arguments_to_parser(parser):
    ...
    parser.add_argument("-output_vcf_name", "--output_vcf_name", dest="output_vcf_name", help="print out vcf, adding in changes to the info column with nref per unrelated", default = False)
...
def run_from_args(args):
    ...
    df1, df2, df3, df4, df5, df6 = calculate_MAF_hist(args.vcf ,samples, unr_samples, 
                                                      ...
                                                      vcf_name = args.output_vcf_name, output_dir=args.output_dir)
